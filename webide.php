...
<head>
  ...
  <title>CodeZone-Web Development</title>
...
<body>
  ...
  <div id="myContainer" class="MainContainer">
    ...
    <div class="content">
      <div>
        <h1 style="font-family: Orbitron;font-weight: bold;">Write HTML, CSS, Node Js, PHP & Run</h1>
      </div>
      <form action="compile.php" name="f1" method="POST">
        <div class="opt">
          <select class="form-control" name="language" id="lang" style="border-radius: 5px; margin-bottom:1rem">
            <option class="form-control" selected>---Select---</option>
            <option class="form-control" value="html">HTML, CSS, JS</option>
            <option class="form-control" value="php">PHP</option>
            <option class="form-control" value="js">Node JS</option>
        ...
        <div style="width: 60%">
          ...
          <div>
            ...
            <button class="button" type="button" onclick="closewin()" style="margin-left:10px;width:180px">Close NodeJs</button>
            <?php
      if(!empty($_SESSION['email']))
      {
        ?>
...
confirmButtonText: '<i class="fa fa-thumbs-up"></i> Great!',
            ...
            error: function() {
                swal({
  type: 'error',
  title: 'Your code could not be sent',
