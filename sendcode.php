<?php
session_start();
if(isset($_POST["language"]) and isset($_POST["code"]))
{
	$error=false;
	if($error==false)
    {
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Your '.$_POST['language'].' Code';
	$mail->Body= 'Thank you for using our online compiler. Find the attachment below to get your code.';
    $mail->AltBody = 'Thank you for using our online compiler. Find the attachment below to get your code.';
    $mail->addStringAttachment($_POST['code'],'code.'.$_POST['language']);
    $mail->send();
	}
	catch (Exception $e)
	{
  ...
  type: 'error',
  title: 'Code Not send',
  text:'Failed to sent the code. Please try again.',
