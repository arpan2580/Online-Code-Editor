...
if(isset($_POST['username']) and isset($_POST['password']))
{
	...
	if($mysqli)
	{
		...
		if($t)
		{
			$result = $mysqli->query("SELECT * FROM `user` WHERE `email` LIKE '".$_POST['username']."' AND `password` LIKE '".$_POST['password']."'");
...
confirmButtonText: '<i class="fa fa-thumbs-up"></i> Great!',
  ...
  text:'Please enter correct email id or password',
  showConfirmButton: true,
confirmButtonColor: '#3085d6',
...
else if(isset($_POST['roll']) and isset($_POST['name']) and isset($_POST['email']) and isset($_POST['pass']) and isset($_POST['conpass']))
{
	$error=false;
...
confirmButtonText: 'OK',
                ...
                <?php
		//echo("Invalid Password and Confirm Password"."<br>"); 
		$error=true;
	}
	if($error==false){
	$email=$_POST['email'];
...
$t=mysqli_connect("localhost","root","");
	if($t)
	{
	$q=mysqli_select_db($t,"online_compiler");
	$a=rand(100000,999999);
	$_SESSION['otp']=$a;
	if($q==1)
	{
	//require 'gmail.php';
	//require_once("C:/xampp/htdocs/online_compiler/gmail.php");
	//include($_SERVER['DOCUMENT_ROOT']."/includes/gmail.php");
/**
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'team.fzone@gmail.com';
    $mail->Password = '3472577234725772';
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('team.fzone@gmail.com', 'Team Online Compiler');
    $mail->addAddress($_SESSION['email'], $_SESSION['name']);
    //$mail->addReplyTo('team.fzone@gmail.com', 'Online Compiler');
    $mail->isHTML(true);
    $mail->Subject = 'Online Compiler Confirmation';
	$mail->Body='Your Online Compiler confirmation key is='.$a;
    $mail->AltBody = 'Your Online Compiler confirmation key is='.$a;
    $mail->send();
	}
	catch (Exception $e)
	{
  ...
  text:'Code could not be sent to the given email',
  showConfirmButton: true,
confirmButtonColor: '#3085d6',
confirmButtonText: 'OK',
});
  ...
  type: 'success',
  title: 'Email Sent',
  text:'Verification code is sent to your email. Please verify yourself.',
  showConfirmButton: true,
confirmButtonColor: '#3085d6',
confirmButtonText: '<i class="fa fa-thumbs-up"></i> Great!',
}).then((result) => {
