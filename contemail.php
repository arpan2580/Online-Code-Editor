<?php
if(isset($_POST['fname']) and isset($_POST['lname']) and isset($_POST['email']) and isset($_POST['mobile']) and isset($_POST['message']))
{
	$error=false;
...
confirmButtonText: 'OK',
	...
	if(is_numeric($_POST['fname']) or is_numeric($_POST['lname']))
	{
        ?>
                <script>
                    swal({
...
try {
    ...
    $mail->addAddress('adas25150@gmail.com', 'Arpan Das');
    //$mail->addReplyTo('team.fzone@gmail.com', 'Online Compiler');
    $mail->isHTML(true);
    $mail->Subject = $_SESSION['fname'].' Send a Message';
	$mail->Body= 'Name= '.$_SESSION['fname'].' '.$_SESSION['lname'].' Mobile= '.$_SESSION['mobile'].' Email= '.$_SESSION['email'].' Message= '.$_SESSION['message'];
    $mail->AltBody = 'Name= '.$_SESSION['fname'].' '.$_SESSION['lname'].' Mobile= '.$_SESSION['mobile'].' Email= '.$_SESSION['email'].' Message= '.$_SESSION['message'];
    $mail->send();
	}
	catch (Exception $e)
	{
  ...
  text:'Failed to sent the message. Please try again.',
  showConfirmButton: true,
confirmButtonColor: '#3085d6',
confirmButtonText: 'OK',
}).then((result) => {
  ...
  type: 'success',
  title: 'Message Sent',
  text:'We have received your message, we will respond quickly. Thanks.',
  showConfirmButton: true,
confirmButtonColor: '#3085d6',
